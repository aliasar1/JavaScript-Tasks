...
function exchange(from: string, to: keyof Rates, amount: number): number {
...
async function askQuestion() {
    ...
    console.log(
        `${answers.cur1} ${chalk.greenBright(
            answers.amountI.toLocaleString("en-US")
        )}/- is equal to ${answers.cur2} ${chalk.green(
